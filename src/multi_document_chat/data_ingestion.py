...
class DocumentIngestor:
    ...
    def __init__(self,temp_dir:str = "C:\\Users\\Karan\\document_portal\\data\\multi_doc_chat", faiss_dir:str = 'faiss_index', session_id:str | None = None ):
            try:
    ...
    def ingest_files(self, uploaded_files):
        try:
            ...
            for uploaded_file in uploaded_files:
                ...
                self.log.info(
                f"File saved for ingestion | "
                f"filename={uploaded_file.name}, "
                f"saved_as={temp_path}, "
            ...
            raise DocumentPortalException(
                "Ingestion error in DocumentIngestor",
                sys
            )
